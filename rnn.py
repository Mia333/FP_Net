...
class CaptioningRNN(object):
    ...
    def loss(self, features, captions):
        ...
        # (2)use word embedding layer to transform captions_in from indices to vectors
        ...
        if self.cell_type == 'rnn':
            h, cache_rnn = rnn_forward(captions_vec, h0, Wx, Wh, b)
        elif self.cell_type == 'lstm':
            h, cache_rnn = lstm_forward(captions_vec, h0, Wx, Wh, b)
        ...
        if self.cell_type == 'rnn':
            dcaptions_vec, dh0, dWx, dWh, db = rnn_backward(dscores, cache_rnn)
        elif self.cell_type == 'lstm':
            dcaptions_vec, dh0, dWx, dWh, db= lstm_backward(dscores, cache_rnn)
        grads['b'], grads['Wh'], grads['Wx'] = db, dWh, dWx
                
        
        # Backprop dx to get gradient for word embedding weights.
        dW_embed = word_embedding_backward(dcaptions_vec, cache_embed)
